...
\begin{itemize}
\item \textt{client\_set\_add} : permet d'ajouter une socket à l'ensemble.
\item \textt{client\_set\_send} : permet d'envoyer un buffer à toutes les \textit{socket} de l'ensemble.
\end{itemize}
